...
ggplot(count_of_crimes, aes(x = reorder(TYPE,total_of_crime), y = sqrt(total_of_crime) )) + 
  ...
  labs( y = "Square Root of Total Crime", x = "Type of Crime Committed", title = "Crime Distribution") +
  geom_text(aes(label = round(sqrt(total_of_crime)), 
                y = sqrt(total_of_crime) + 20))
